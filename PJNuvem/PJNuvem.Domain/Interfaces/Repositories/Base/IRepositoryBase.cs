...
namespace PJNuvem.Domain.Interfaces.Repositories.Base
{
       ...
       where TId : struct
    {
        ...
        TEntidade EditarRemovendoProperties(TEntidade entidade, params Expression<Func<TEntidade, object>>[] includeProperties);
